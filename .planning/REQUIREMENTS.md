...
- [x] **DEC-02**: Decryption works for tokens **outside** the registry (paste-an-address and/or auto-detect)
...
- [x] **UX-03**: The async unwrap "pending decryption" wait is presented as production-grade UX, not a silent hang
