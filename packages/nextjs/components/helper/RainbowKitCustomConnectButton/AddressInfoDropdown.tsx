  ...
  return (
    <>
      <details ref={dropdownRef} className="dropdown dropdown-end leading-3">
        ...
        <ul className="cellar-menu dropdown-content menu z-2 p-2 mt-2 rounded-box gap-1">
          <NetworkOptions hidden={!selectingNetwork} />
          {allowedNetworks.length > 1 ? (
            <li className={selectingNetwork ? "hidden" : ""}>
              <button
                className="cellar-menu-item h-8 btn-sm rounded-xl! flex gap-3 py-3"
                type="button"
                onClick={() => {
          ...
          <li className={selectingNetwork ? "hidden" : ""}>
            <button
              className="cellar-menu-item cellar-menu-item--danger h-8 btn-sm rounded-xl! flex gap-3 py-3"
              type="button"
              onClick={() => disconnect()}
            >
